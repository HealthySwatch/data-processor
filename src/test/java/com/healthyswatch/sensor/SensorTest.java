...
public class SensorTest {
    ...
    static void beforeAll() {
        CORE = new HSWCore(
                new EncryptionRepositoryTest("MyP4$sw0rd"),
    ...
    public void tickSensors() {
        long start = System.currentTimeMillis() - TimeUnit.HOURS.toMillis(1), now, diff = TimeUnit.SECONDS.toMillis(10);
    ...
    public void dailyReport() {
        ...
        CORE.getTrackingRepository().getRemoteTrackingSettings().setEnabled(false);
        CORE.getTrackingManager().createDailyReport();
        ...
        assertEquals(30, report.getSamples().values().stream().mapToLong(Collection::size).sum());
    }
